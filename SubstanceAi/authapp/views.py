...
#         # redirect_url = f"http://localhost:3000/?user={user['username']}"
#         redirect_url = f"http://localhost:3000/home"
...
#             "user": user_data,
#             "redirect_url": f"http://localhost:3000/home"
#             # "redirect_url": f"http://localhost:3000/?user={user_data['username']}"
#         }, status=status.HTTP_200_OK)
...
#     # return redirect(f"http://localhost:3000/?user={user_data['name']}&id={user_id}")
#     return redirect(f"http://localhost:3000/home")
